...
type Addition struct {
	...
	DownloadParams string `json:"download_params" type:"text" help:"Extra query parameters appended to the URL on download (not on preview). Magic variables: {{.Name}} {{.Path}} {{.Size}} {{.Modified}}; name and path values are URL-encoded automatically. e.g. attname={{.Name}}"`
}
