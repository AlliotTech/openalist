...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.Announcement, Value: "### repo\nhttps://github.com/AlliotTech/openalist", Type: conf.TypeText, Group: model.SITE},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Value: "https://sinkhole.shadowserver.org/ocr/file/json", Type: conf.TypeString, Group: model.GLOBAL},
